...
ntuple_list lsd_scale(image_double image, double scale)
{
  ...
  double quant = 2.0;       /* Bound to the quantization error on the
                                gradient norm.                                */
  double ang_th = 22.5;//sysPara.lsd_angle_th;     /* Gradient angle tolerance in degrees.  22.5          */
  double eps = 0.0;         /* Detection threshold, -log10(NFA).              */
  double density_th = 0.7;//0.7//sysPara.lsd_density_th; /* Minimal density of region points in rectangle. 0.7*/
